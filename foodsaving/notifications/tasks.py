...
def create_pickup_upcoming_notifications():
    # Oh oh, this is a bit complex. As notification.context is a JSONField, the subquery would return a jsonb object by default (which can't be compared to integer)
