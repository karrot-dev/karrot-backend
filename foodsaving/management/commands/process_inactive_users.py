...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print ("Removing inactive users in groups who have been inactive since:",datetime.strftime(remove_threshold_date,'%Y-%m-%d'))
        ...
        print ("Flagging inactive users in groups who have been inactive since:",datetime.strftime(inactive_threshold_date,'%Y-%m-%d'))
