...
from karrot.pickups.filters import (
    PickupDatesFilter,
...
class FeedbackViewSet(
    ...
    def list(self, request, *args, **kwargs):
        queryset = (
            ...
            .prefetch_related(
                "about__pickupdatecollector_set", "about__feedback_given_by"
            )
        )
        ...
        return self.get_paginated_response(
            {"feedback": serializer.data, "pickups": pickups_serializer.data,}
        )
...
class PickupDateViewSet(
    ...
    def get_queryset(self):
        qs = self.queryset.filter(
            place__group__members=self.request.user,
