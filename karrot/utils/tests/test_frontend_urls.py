...
class TestAbsoluteURL(TestCase):
    ...
    def test_existing_absolute_url(self):
        self.assertEqual(
            absolute_url("http://example.com/yay"), "http://example.com/yay"
        )
        self.assertEqual(
            absolute_url("https://example.com/yay"), "https://example.com/yay"
        )
    ...
    def test_group_photo_url(self):
        ...
        self.assertEqual(
            ...
            "{hostname}/api/groups-info/{id}/photo/".format(
                hostname=settings.HOSTNAME, id=group.id,
            ),
        )
    ...
    def test_offer_image_url(self):
        ...
        self.assertEqual(
            ...
            "{hostname}/api/offers/{id}/image/".format(
                hostname=settings.HOSTNAME, id=offer.id,
            ),
        )
